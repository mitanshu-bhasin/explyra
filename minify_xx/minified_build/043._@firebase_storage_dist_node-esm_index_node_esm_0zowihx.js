 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S={RAW:"raw",BASE64:"base64",BASE64URL:"base64url",DATA_URL:"data_url"};class N{constructor(e,t){this.data=e,this.contentType=t||null}}function x(e,t){switch(e){case S.RAW:return new N(P(t));case S.BASE64:case S.BASE64URL:return new N(D(e,t));case S.DATA_URL:return new N(function(e){const t=new L(e);return t.base64?D(S.BASE64,t.rest):function(e){let t;try{t=decodeURIComponent(e)}catch(e){throw m(S.DATA_URL,"Malformed data URL.")}return P(t)}(t.rest)}(t),new L(t).contentType)}throw l()}function P(e){const t=[];for(let n=0;n<e.length;n++){let s=e.charCodeAt(n);s<=127?t.push(s):s<=2047?t.push(192|s>>6,128|63&s):55296==(64512&s)?n<e.length-1&&56320==(64512&e.charCodeAt(n+1))?(s=65536|(1023&s)<<10|1023&e.charCodeAt(++n),t.push(240|s>>18,128|s>>12&63,128|s>>6&63,128|63&s)):t.push(239,191,189):56320==(64512&s)?t.push(239,191,189):t.push(224|s>>12,128|s>>6&63,128|63&s)}return new Uint8Array(t)}function D(e,t){switch(e){case S.BASE64:{const n=-1!==t.indexOf("-"),s=-1!==t.indexOf("_");if(n||s)throw m(e,"Invalid character '"+(n?"-":"_")+"' found: is it base64url encoded?");break}case S.BASE64URL:{const n=-1!==t.indexOf("+"),s=-1!==t.indexOf("/");if(n||s)throw m(e,"Invalid character '"+(n?"+":"/")+"' found: is it base64 encoded?");t=t.replace(/-/g,"+").replace(/_/g,"/");break}}let n;try{n=
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const V="prefixes",$="items";class X{constructor(e,t,n,s){this.url=e,this.method=t,this.handler=n,this.timeout=s,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class _e{constructor(){this.errorText_="",this.sent_=!1,this.errorCode_=c.NO_ERROR}async send(e,t,n,s,r){if(this.sent_)throw b("cannot .send() more than once");this.sent_=!0;try{const o=await Re(e,t,n,r,s);this.headers_=o.headers,this.statusCode_=o.status,this.errorCode_=c.NO_ERROR,this.body_=await o.arrayBuffer()}catch(e){this.errorText_=e?.message,this.statusCode_=0,this.errorCode_=c.NETWORK_ERROR}}getErrorCode(){if(void 0===this.errorCode_)throw b("cannot .getErrorCode() before receiving response");return this.errorCode_}getStatus(){if(void 0===this.statusCode_)throw b("cannot .getStatus() before receiving response");return this.statusCode_}getErrorText(){return this.errorText_}abort(){}getResponseHeader(e){if(!this.headers_)throw b("cannot .getResponseHeader() before receiving response");return this.headers_.get(e)}addUploadProgressListener(e){}removeUploadProgressListener(e){}}class pe extends _e{getResponse(){if(!this.body_)throw b("cannot .getResponse() before receiving response");return Buffer.from(this.body_).toString("utf-8")}}function fe(){return new pe}class ge extends _e{getResponse(){if(!this.body_)throw b("cannot .getResponse() before sending");return this.body_}}function me(){return new ge}class be extends _e{constructor(){super(...arguments),this.stream_=null}async send(e,t,n,s,r){if(this.sent_)throw b("cannot .send() more than once");this.sent_=!0;try{const o=await Re(e,t,n,r,s);this.headers_=o.headers,this.statusCode_=o.status,this.errorCode_=c.NO_ERROR,this.stream_=o.body}catch(e){this.errorText_=e?.message,this.statusCode_=0,this.errorCode_=c.NETWORK_ERROR}}getResponse(){if(!this.stream_)throw b("cannot .getResponse() before sending");return this.stream_}}function Re(e,t,s,r,o){const i={method:t,headers:r||{},body:o};return(0,n.isCloudWorkstation)(e)&&s&&(i.credentials="include"),fetch(e,i)}function Te(){return new be}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}}class ke{constructor(e,t){this._service=e,this._location=t instanceof R?t:R.makeFromUrl(t,e.host)}toString(){return"gs://"+this._location.bucket+"/"+this._location.path}_newRef(e,t){return new ke(e,t)}get root(){const e=new R(this._location.bucket,"");return this._newRef(this._service,e)}get bucket(){return this._location.bucket}get fullPath(){return this._location.path}get name(){return q(this._location.path)}get storage(){return this._service}get parent(){const e=function(e){if(0===e.length)return null;const t=e.lastIndexOf("/");return-1===t?"":e.slice(0,t)}(this._location.path);if(null===e)return null;const t=new R(this._location.bucket,e);return new ke(this._service,t)}_throwIfRoot(e){if(""===this._location.path)throw g(e)}}function ve(e,t,n){e._throwIfRoot("uploadBytes");const s=se(e.storage,e._location,j(),new B(t,!0),n);return e.storage.makeRequestWithTokens(s,fe).then(t=>({metadata:t,ref:e}))}function Ee(e){const t={prefixes:[],items:[]};return ye(e,t).then(()=>t)}async function ye(e,t,n){const s={pageToken:n},r=await Ue(e,s);t.prefixes.push(...r.prefixes),t.items.push(...r.items),null!=r.nextPageToken&&await ye(e,t,r.nextPageToken)}function Ue(e,t){null!=t&&"number"==typeof t.maxResults&&E("options.maxResults",1,1e3,t.maxResults);const n=t||{},s=ee(e.storage,e._location,"/",n.pageToken,n.maxResults);return e.storage.makeRequestWithTokens(s,fe)}function Oe(e){e._throwIfRoot("getDownloadURL");const t=function(e,t,n){const s=y(t.fullServerUrl(),e.host,e._protocol),r=e.maxOperationRetryTime,o=new X(s,"GET",function(e,t){return function(n,s){const r=W(e,s,t);return K(null!==r),function(e,t,n,s){const r=M(t);if(null===r)return null;if(!w(r.downloadTokens))return null;const o=r.downloadTokens;if(0===o.length)return null;const i=encodeURIComponent;return o.split(",").map(t=>{const r=e.bucket,o=e.fullPath;return y("/b/"+i(r)+"/o/"+i(o),n,s)+U({alt:"media",token:t})})[0]}(r,s,e.host,e._protocol)}}(e,n),r);return o.errorHandler=Y(t),o}(e.storage,e._location,j());return e.storage.makeRequestWithTokens(t,fe).then(e=>{if(null===e)throw new i(a.NO_DOWNLOAD_URL,"The given file does not have any download URLs.");return e})}function Ce(e,t){const n=function(e,t){const n=t.split("/").filter(e=>e.length>0).join("/");return 0===e.length?n:e+"/"+n}(e._location.path,t),s=new R(e._location.bucket,n);return new ke(e.storage,s)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ae(e,t){if(e instanceof Ne){const n=e;if(null==n._bucket)throw new i(a.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+o+"' property when initializing the app?");const s=new ke(n,n._bucket);return null!=t?Ae(s,t):s}return void 0!==t?Ce(e,t):e}function Ie(e,t){if(t&&/^[A-Za-z]+:\/\//.test(t)){if(e instanceof Ne)return new ke(e,t);throw p("To use ref(service, url), the first argument must be a Storage instance.")}return Ae(e,t)}function Se(e,t){const n=t?.[o];return null==n?null:R.makeFromBucketSpec(n,e)}class Ne{constructor(e,t,n,s,o,i=!1){this.app=e,this._authProvider=t,this._appCheckProvider=n,this._url=s,this._firebaseVersion=o,this._isUsingEmulator=i,this._bucket=null,this._host=r,this._protocol="https",this._appId=null,this._deleted=!1,this._maxOperationRetryTime=12e4,this._maxUploadRetryTime=6e5,this._requests=new Set,this._bucket=null!=s?R.makeFromBucketSpec(s,this._host):Se(this._host,this.app.options)}get host(){return this._host}set host(e){this._host=e,null!=this._url?this._bucket=R.makeFromBucketSpec(this._url,e):this._bucket=Se(e,this.app.options)}get maxUploadRetryTime(){return this._maxUploadRetryTime}set maxUploadRetryTime(e){E("time",0,Number.POSITIVE_INFINITY,e),this._maxUploadRetryTime=e}get maxOperationRetryTime(){return this._maxOperationRetryTime}set maxOperationRetryTime(e){E("time",0,Number.POSITIVE_INFINITY,e),this._maxOperationRetryTime=e}async _getAuthToken(){if(this._overrideAuthToken)return this._overrideAuthToken;const e=this._authProvider.getImmediate({optional:!0});if(e){const t=await e.getToken();if(null!==t)return t.accessToken}return null}async _getAppCheckToken(){if((0,t._isFirebaseServerApp)(this.app)&&this.app.settings.appCheckToken)return this.app.settings.appCheckToken;const e=this._appCheckProvider.getImmediate({optional:!0});return e?(await e.getToken()).token:null}_delete(){return this._deleted||(this._deleted=!0,this._requests.forEach(e=>e.cancel()),this._requests.clear()),Promise.resolve()}_makeStorageReference(e){return new ke(this,e)}_makeRequest(e,t,n,s,r=!0){if(this._deleted)return new T(f());{const o=function(e,t,n,s,r,o,i=!0,a=!1){const c=U(e.urlParams),u=e.url+c,l=Object.assign({},e.headers);return function(e,t){t&&(e["X-Firebase-GMPID"]=t)}(l,t),function(e,t){null!==t&&t.length>0&&(e.Authorization="Firebase "+t)}(l,n),function(e,t){e["X-Firebase-Storage-Version"]="webjs/"+(t??"AppManager")}(l,o),function(e,t){null!==t&&(e["X-Firebase-AppCheck"]=t)}(l,s),new C(u,e.method,l,e.body,e.successCodes,e.additionalRetryCodes,e.handler,e.errorHandler,e.timeout,e.progressCallback,r,i,a)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Pe(e,t){return function(e,t){e._throwIfRoot("getBytes");const n=te(e.storage,e._location,t);return e.storage.makeRequestWithTokens(n,me).then(e=>void 0!==t?e.slice(0,t):e)}(e=(0,n.getModularInstance)(e),t)}function De(e,t,s){return ve(e=(0,n.getModularInstance)(e),t,s)}function Le(e,t,s,r){return function(e,t,n=S.RAW,s){e._throwIfRoot("uploadString");const r=x(n,t),o={...s};return null==o.contentType&&null!=r.contentType&&(o.contentType=r.contentType),ve(e,r.data,o)}(e=(0,n.getModularInstance)(e),t,s,r)}function Be(e,t,s){return function(e,t,n){return e._throwIfRoot("uploadBytesResumable"),new we(e,new B(t),n)}(e=(0,n.getModularInstance)(e),t,s)}function Me(e){return function(e){e._throwIfRoot("getMetadata");const t=Q(e.storage,e._location,j());return e.storage.makeRequestWithTokens(t,fe)}(e=(0,n.getModularInstance)(e))}function qe(e,t){return function(e,t){e._throwIfRoot("updateMetadata");const n=function(e,t,n,s){const r=y(t.fullServerUrl(),e.host,e._protocol),o=G(n,s),i=e.maxOperationRetryTime,a=new X(r,"PATCH",Z(e,s),i);return a.headers={"Content-Type":"application/json; charset=utf-8"},a.body=o,a.errorHandler=Y(t),a}(e.storage,e._location,t,j());return e.storage.makeRequestWithTokens(n,fe)}(e=(0,n.getModularInstance)(e),t)}function Fe(e,t){return Ue(e=(0,n.getModularInstance)(e),t)}function He(e){return Ee(e=(0,n.getModularInstance)(e))}function ze(e){return Oe(e=(0,n.getModularInstance)(e))}function je(e){return function(e){e._throwIfRoot("deleteObject");const t=function(e,t){const n=y(t.fullServerUrl(),e.host,e._protocol),s=e.maxOperationRetryTime,r=new X(n,"DELETE",function(e,t){},s);return r.successCodes=[200,204],r.errorHandler=Y(t),r}(e.storage,e._location);return e.storage.makeRequestWithTokens(t,fe)}(e=(0,n.getModularInstance)(e))}function We(e,t){return Ie(e=(0,n.getModularInstance)(e),t)}function Ge(e,t){return Ce(e,t)}function Ve(e=(0,t.getApp)(),s){e=(0,n.getModularInstance)(e);const r=(0,t._getProvider)(e,xe).getImmediate({identifier:s}),o=(0,n.getDefaultEmulatorHostnameAndPort)("storage");return o&&$e(r,...o),r}function $e(e,t,s,r={}){!function(e,t,s,r={}){e.host=`${t}:${s}`;const o=(0,n.isCloudWorkstation)(t);o&&(0,n.pingServer)(`https://${e.host}/b`),e._isUsingEmulator=!0,e._protocol=o?"https":"http";const{mockUserToken:i}=r;i&&(e._overrideAuthToken="string"==typeof i?i:(0,n.createMockUserToken)(i,e.app.options.projectId))}(e,t,s,r)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Xe(e,t){throw new Error("getBlob() is only available in Browser-like environments")}function Ke(e,t){return function(e,t){e._throwIfRoot("getStream");const n=te(e.storage,e._location,t),s=void 0!==t?new TransformStream((e=>{let t=e;return{transform(e,n){e.length<t?(n.enqueue(e),t-=e.length):(n.enqueue(e.slice(0,t)),n.terminate())}}})(t)):new TransformStream;return e.storage.makeRequestWithTokens(n,Te).then(e=>e.pipeThrough(s)).catch(e=>s.writable.abort(e)),s.readable}(e=(0,n.getModularInstance)(e),t)}(0,t._registerComponent)(new s.Component(xe,function(e,{instanceIdentifier:n}){const s=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),o=e.getProvider("app-check-internal");return new Ne(s,r,o,n,t.SDK_VERSION)},"PUBLIC").setMultipleInstances(!0)),(0,t.registerVersion)("@firebase/storage","0.14.2")}];