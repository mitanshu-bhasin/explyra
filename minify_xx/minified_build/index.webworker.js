import{SDK_VERSION,_getProvider,_isFirebaseServerApp,_registerComponent,registerVersion,getApp}from"@firebase/app";import{ErrorFactory,deepEqual,getUA,isBrowserExtension,isMobileCordova,isReactNative,FirebaseError,querystring,isCloudflareWorker,isCloudWorkstation,getModularInstance,base64Decode,createSubscribe,pingServer,updateEmulatorBanner,querystringDecode,extractQuerystring}from"@firebase/util";import{Logger,LogLevel}from"@firebase/logger";import{Component}from"@firebase/component";
/**
 * @license
