 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ee(e){return Number.isFinite(e)?e+function(e){const t=(e=Math.abs(e))%100;if(t>=10&&t<=20)return"th";const r=e%10;return 1===r?"st":2===r?"nd":3===r?"rd":"th"}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */r.NODE_CLIENT=!0},"[project]/booking/node_modules/@firebase/component/dist/esm/index.esm.js [app-rsc] (ecmascript)",e=>{"use strict";e.s(["Component",()=>r,"ComponentContainer",()=>o,"Provider",()=>i]);var t=e.i("[project]/booking/node_modules/@firebase/util/dist/node-esm/index.node.esm.js [app-rsc] (ecmascript)");class r{constructor(e,t,r){this.name=e,this.instanceFactory=t,this.type=r,this.multipleInstances=!1,this.serviceProps={},this.instantiationMode="LAZY",this.onInstanceCreated=null}setInstantiationMode(e){return this.instantiationMode=e,this}setMultipleInstances(e){return this.multipleInstances=e,this}setServiceProps(e){return this.serviceProps=e,this}setInstanceCreatedCallback(e){return this.onInstanceCreated=e,this
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class i{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(e){const r=this.normalizeInstanceIdentifier(e);if(!this.instancesDeferred.has(r)){const n=new t.Deferred;if(this.instancesDeferred.set(r,n),this.isInitialized(r)||this.shouldAutoInitialize())try{const e=this.getOrInitializeService({instanceIdentifier:r});e&&n.resolve(e)}catch(e){}}return this.instancesDeferred.get(r).promise}getImmediate(e){const t=this.normalizeInstanceIdentifier(e?.identifier),r=e?.optional??!1;if(!this.isInitialized(t)&&!this.shouldAutoInitialize()){if(r)return null;throw Error(`Service ${this.name} is not available`)}try{return this.getOrInitializeService({instanceIdentifier:t})}catch(e){if(r)return null;throw e}}getComponent(){return this.component}setComponent(e){if(e.name!==this.name)throw Error(`Mismatching Component ${e.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=e,this.shouldAutoInitialize()){if(function(e){return"EAGER"===e.instantiationMode}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Y(e,t){const r=(0,n.base64Decode)(e.split(".")[1]);null!==r?void 0!==JSON.parse(r).exp?1e3*JSON.parse(r).exp-(new Date).getTime()<=0&&console.error(`FirebaseServerApp ${t} is invalid: the token has expired.`):console.error(`FirebaseServerApp ${t} is invalid: expiration claim could not be parsed`):console.error(`FirebaseServerApp ${t} is invalid: second part could not be parsed.`)}class X extends K{constructor(e,t,r,n){const i=void 0===t.automaticDataCollectionEnabled||t.automaticDataCollectionEnabled,o={name:r,automaticDataCollectionEnabled:i};void 0!==e.apiKey?super(e,o,n):super(e.options,o,n),this._serverConfig={automaticDataCollectionEnabled:i,...t},this._serverConfig.authIdToken&&Y(this._serverConfig.authIdToken,"authIdToken"),this._serverConfig.appCheckToken&&Y(this._serverConfig.appCheckToken,"appCheckToken"),this._finalizationRegistry=null,"undefined"!=typeof FinalizationRegistry&&(this._finalizationRegistry=new FinalizationRegistry(()=>{this.automaticCleanup()})),this._refCount=0,this.incRefCount(this._serverConfig.releaseOnDeref),this._serverConfig.releaseOnDeref=void 0,t.releaseOnDeref=void 0,oe(s,a,"serverapp")}toJSON(){}get refCount(){return this._refCount}incRefCount(e){this.isDeleted||(this._refCount++,void 0!==e&&null!==this._finalizationRegistry&&this._finalizationRegistry.register(e,this))}decRefCount(){return this.isDeleted?0:--this._refCount}automaticCleanup(){ie(this)}get settings(){return this.checkDestroyed(),this._serverConfig}checkDestroyed(){if(this.isDeleted)throw G.create("server-app-deleted")}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Q="12.11.0";function ee(e,r={}){let i=e;"object"!=typeof r&&(r={name:r});const o={name:B,automaticDataCollectionEnabled:!0,...r},s=o.name;if("string"!=typeof s||!s)throw G.create("bad-app-name",{appName:String(s)});if(i||(i=(0,n.getDefaultAppConfig)()),!i)throw G.create("no-options");const a=R.get(s);if(a){if((0,n.deepEqual)(i,a.options)&&(0,n.deepEqual)(o,a.config))return a;throw G.create("duplicate-app",{appName:s})}const c=new t.ComponentContainer(s);for(const e of F.values())c.addComponent(e);const u=new K(i,o,c);return R.set(s,u),u}function te(e,r={}){if((0,n.isBrowser)()&&!(0,n.isWebWorker)())throw G.create("invalid-server-app-environment");let i,o=r||{};if(e&&(V(e)?i=e.options:q(e)?o=e:i=e),void 0===o.automaticDataCollectionEnabled&&(o.automaticDataCollectionEnabled=!0),i||(i=(0,n.getDefaultAppConfig)()),!i)throw G.create("no-options");const s={...o,...i};if(void 0!==s.releaseOnDeref&&delete s.releaseOnDeref,void 0!==o.releaseOnDeref&&"undefined"==typeof FinalizationRegistry)throw G.create("finalization-registry-not-supported",{});const a=""+(c=JSON.stringify(s),[...c].reduce((e,t)=>Math.imul(31,e)+t.charCodeAt(0)|0,0));var c;const u=P.get(a);if(u)return u.incRefCount(o.releaseOnDeref),u;const h=new t.ComponentContainer(a);for(const e of F.values())h.addComponent(e);const l=new X(i,o,a,h);return P.set(a,l),l}function re(e=B){const t=R.get(e);if(!t&&e===B&&(0,n.getDefaultAppConfig)())return ee();if(!t)throw G.create("no-app",{appName:e});return t}function ne(){return Array.from(R.values())}async function ie(e){let t=!1;const r=e.name;R.has(r)?(t=!0,R.delete(r)):P.has(r)&&e.decRefCount()<=0&&(P.delete(r),t=!0),t&&(await Promise.all(e.container.getProviders().map(e=>e.delete())),e.isDeleted=!0)}function oe(e,r,n){let i=M[e]??e;n&&(i+=`-${n}`);const o=i.match(/\s|\//),s=r.match(/\s|\//);if(o||s){const e=[`Unable to register library "${i}" with version "${r}":`];return o&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),o&&s&&e.push("and"),s&&e.push(`version name "${r}" contains illegal characters (whitespace or "/")`),void c.warn(e.join(" "))}$(new t.Component(`${i}-version`,()=>({library:i,version:r}),"VERSION"))}function se(e,t){if(null!==e&&"function"!=typeof e)throw G.create("invalid-log-argument");(0,r.setUserLogHandler)(e,t)}function ae(e){(0,r.setLogLevel)(e)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ce="firebase-heartbeat-store";let ue=null;function he(){return ue||(ue=(0,i.openDB)("firebase-heartbeat-database",1,{upgrade:(e,t)=>{if(0===t)try{e.createObjectStore(ce)}catch(e){console.warn(e)}}}).catch(e=>{throw G.create("idb-open",{originalErrorMessage:e.message})})),ue}async function le(e,t){try{const r=(await he()).transaction(ce,"readwrite"),n=r.objectStore(ce);await n.put(t,fe(e)),await r.done}catch(e){if(e instanceof n.FirebaseError)c.warn(e.message);else{const t=G.create("idb-set",{originalErrorMessage:e?.message});c.warn(t.message)}}}function fe(e){return`${e.name}!${e.options.appId}`
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}class de{constructor(e){this.container=e,this._heartbeatsCache=null;const t=this.container.getProvider("app").getImmediate();this._storage=new ge(t),this._heartbeatsCachePromise=this._storage.read().then(e=>(this._heartbeatsCache=e,e))}async triggerHeartbeat(){try{const e=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),t=pe();if(null==this._heartbeatsCache?.heartbeats&&(this._heartbeatsCache=await this._heartbeatsCachePromise,null==this._heartbeatsCache?.heartbeats))return;if(this._heartbeatsCache.lastSentHeartbeatDate===t||this._heartbeatsCache.heartbeats.some(e=>e.date===t))return;if(this._heartbeatsCache.heartbeats.push({date:t,agent:e}),this._heartbeatsCache.heartbeats.length>30){const e=function(e){if(0===e.length)return-1;let t=0,r=e[0].date;for(let n=1;n<e.length;n++)e[n].date<r&&(r=e[n].date,t=n);return t}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(e,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(e){c.warn(e)}}async getHeartbeatsHeader(){try{if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null==this._heartbeatsCache?.heartbeats||0===this._heartbeatsCache.heartbeats.length)return"";const e=pe(),{heartbeatsToSend:t,unsentEntries:r}=function(e,t=1024){const r=[];let n=e.slice();for(const i of e){const e=r.find(e=>e.agent===i.agent);if(e){if(e.dates.push(i.date),me(r)>t){e.dates.pop();break}}else if(r.push({agent:i.agent,dates:[i.date]}),me(r)>t){r.pop();break}n=n.slice(1)}return{heartbeatsToSend:r,unsentEntries:n}}(this._heartbeatsCache.heartbeats),i=(0,n.base64urlEncodeWithoutPadding)(JSON.stringify({version:2,heartbeats:t}));return this._heartbeatsCache.lastSentHeartbeatDate=e,r.length>0?(this._heartbeatsCache.heartbeats=r,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),i}catch(e){return c.warn(e),""}}}function pe(){return(new Date).toISOString().substring(0,10)}class ge{constructor(e){this.app=e,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return!!(0,n.isIndexedDBAvailable)()&&(0,n.validateIndexedDBOpenable)().then(()=>!0).catch(()=>!1)}async read(){if(await this._canUseIndexedDBPromise){const e=await async function(e){try{const t=(await he()).transaction(ce),r=await t.objectStore(ce).get(fe(e));return await t.done,r}catch(e){if(e instanceof n.FirebaseError)c.warn(e.message);else{const t=G.create("idb-get",{originalErrorMessage:e?.message});c.warn(t.message)}}}(this.app);return e?.heartbeats?e:{heartbeats:[]}}return{heartbeats:[]}}async overwrite(e){if(await this._canUseIndexedDBPromise){const t=await this.read();return le(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??t.lastSentHeartbeatDate,heartbeats:e.heartbeats})}}async add(e){if(await this._canUseIndexedDBPromise){const t=await this.read();return le(this.app,{lastSentHeartbeatDate:e.lastSentHeartbeatDate??t.lastSentHeartbeatDate,heartbeats:[...t.heartbeats,...e.heartbeats]})}}}function me(e){return(0,n.base64urlEncodeWithoutPadding)(JSON.stringify({version:2,heartbeats:e})).length}$(new t.Component("platform-logger",e=>new o(e),"PRIVATE")),$(new t.Component("heartbeat",e=>new de(e),"PRIVATE")),oe(s,a,""),oe(s,a,"esm2020"),oe("fire-js","")},"[project]/booking/node_modules/firebase/app/dist/index.mjs [app-rsc] (ecmascript) <locals>",e=>{"use strict";e.s([]),
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 *
 */Object.defineProperty(r,"__esModule",{value:!0}),r.addCommonProtos=r.loadProtosWithOptionsSync=r.loadProtosWithOptions=void 0;const n=e.r("[externals]/fs [external] (fs, cjs)"),i=e.r("[externals]/path [external] (path, cjs)"),o=e.r("[project]/booking/node_modules/protobufjs/index.js [app-rsc] (ecmascript)");function s(e,t){const r=e.resolvePath;e.resolvePath=(e,o)=>{if(i.isAbsolute(o))return o;for(const r of t){const t=i.join(r,o);try{return n.accessSync(t,n.constants.R_OK),t}catch(e){continue}}return process.emitWarning(`${o} not found in any of the include paths ${t}`),r(e,o)}}r.loadProtosWithOptions=async function(e,t){const r=new o.Root;if((t=t||{}).includeDirs){if(!Array.isArray(t.includeDirs))return Promise.reject(new Error("The includeDirs option must be an array"));s(r,t.includeDirs)}const n=await r.load(e,t);return n.resolveAll(),n},r.loadProtosWithOptionsSync=function(e,t){const r=new o.Root;if((t=t||{}).includeDirs){if(!Array.isArray(t.includeDirs))throw new Error("The includeDirs option must be an array");s(r,t.includeDirs)}const n=r.loadSync(e,t);return n.resolveAll(),n},r.addCommonProtos=function(){const t=e.r("[project]/booking/node_modules/protobufjs/google/protobuf/api.json.[json].cjs [app-rsc] (ecmascript)"),r=e.r("[project]/booking/node_modules/protobufjs/google/protobuf/descriptor.json.[json].cjs [app-rsc] (ecmascript)"),n=e.r("[project]/booking/node_modules/protobufjs/google/protobuf/source_context.json.[json].cjs [app-rsc] (ecmascript)"),i=e.r("[project]/booking/node_modules/protobufjs/google/protobuf/type.json.[json].cjs [app-rsc] (ecmascript)");o.common("api",t.nested.google.nested.protobuf.nested),o.common("descriptor",r.nested.google.nested.protobuf.nested),o.common("source_context",n.nested.google.nested.protobuf.nested),o.common("type",i.nested.google.nested.protobuf.nested)}},"[project]/booking/node_modules/@grpc/proto-loader/build/src/index.js [app-rsc] (ecmascript)",(e,t,r)=>{"use strict";
/**
 * @license
 * Copyright 2018 gRPC authors.
 *
