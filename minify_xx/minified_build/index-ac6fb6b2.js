"use strict";var app=require("@firebase/app"),util=require("@firebase/util"),logger=require("@firebase/logger"),component=require("@firebase/component");
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function signInWithRedirect(e,t,r){return _signInWithRedirect(e,t,r)}async function _signInWithRedirect(e,t,r){if(app._isFirebaseServerApp(e.app))return Promise.reject(_serverAppCurrentUserOperationNotSupportedError(e));const n=_castAuth(e);_assertInstanceOf(e,t,FederatedAuthProvider),await n._initializationPromise;const i=_withDefaultResolver(n,r);return await _setPendingRedirectStatus(i,n),i._openRedirect(n,t,"signInViaRedirect")}function reauthenticateWithRedirect(e,t,r){return _reauthenticateWithRedirect(e,t,r)}async function _reauthenticateWithRedirect(e,t,r){const n=util.getModularInstance(e);if(_assertInstanceOf(n.auth,t,FederatedAuthProvider),app._isFirebaseServerApp(n.auth.app))return Promise.reject(_serverAppCurrentUserOperationNotSupportedError(n.auth));await n.auth._initializationPromise;const i=_withDefaultResolver(n.auth,r);await _setPendingRedirectStatus(i,n.auth);const s=await prepareUserForRedirect(n);return i._openRedirect(n.auth,t,"reauthViaRedirect",s)}function linkWithRedirect(e,t,r){return _linkWithRedirect(e,t,r)}async function _linkWithRedirect(e,t,r){const n=util.getModularInstance(e);_assertInstanceOf(n.auth,t,FederatedAuthProvider),await n.auth._initializationPromise;const i=_withDefaultResolver(n.auth,r);await _assertLinkedStatus(!1,n,t.providerId),await _setPendingRedirectStatus(i,n.auth);const s=await prepareUserForRedirect(n);return i._openRedirect(n.auth,t,"linkViaRedirect",s)}async function getRedirectResult(e,t){return await _castAuth(e)._initializationPromise,_getRedirectResult(e,t,!1)}async function _getRedirectResult(e,t,r=!1){if(app._isFirebaseServerApp(e.app))return Promise.reject(_serverAppCurrentUserOperationNotSupportedError(e));const n=_castAuth(e),i=_withDefaultResolver(n,t),s=new RedirectAction(n,i,r),o=await s.execute();return o&&!r&&(delete o.user._redirectEventId,await n._persistUserIfCurrent(o.user),await n._setRedirectUser(null,t)),o}async function prepareUserForRedirect(e){const t=_generateEventId(`${e.uid}:::`);return e._redirectEventId=t,await e.auth._setRedirectUser(e),await e.auth._persistUserIfCurrent(e),t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const BASE_POPUP_OPTIONS={location:"yes",resizable:"yes",statusbar:"yes",toolbar:"no"},DEFAULT_WIDTH=500,DEFAULT_HEIGHT=600,TARGET_BLANK="_blank",FIREFOX_EMPTY_URL="http://localhost";class AuthPopup{constructor(e){this.window=e,this.associatedEvent=null}close(){if(this.window)try{this.window.close()}catch(e){}}}function _open(e,t,r,n=500,i=600){const s=Math.max((window.screen.availHeight-i)/2,0).toString(),o=Math.max((window.screen.availWidth-n)/2,0).toString();let a="";const c={...BASE_POPUP_OPTIONS,width:n.toString(),height:i.toString(),top:s,left:o},u=util.getUA().toLowerCase();r&&(a=_isChromeIOS(u)?"_blank":r),_isFirefox(u)&&(t=t||FIREFOX_EMPTY_URL,c.scrollbars="yes");const d=Object.entries(c).reduce((e,[t,r])=>`${e}${t}=${r},`,"");if(_isIOSStandalone(u)&&"_self"!==a)return openAsNewWindowIOS(t||"",a),new AuthPopup(null);const l=window.open(t||"",a,d);_assert(l,e,"popup-blocked");try{l.focus()}catch(e){}return new AuthPopup(l)}function openAsNewWindowIOS(e,t){const r=document.createElement("a");r.href=e,r.target=t;const n=document.createEvent("MouseEvent");n.initMouseEvent("click",!0,!0,window,1,0,0,0,0,!1,!1,!1,!1,1,null),r.dispatchEvent(n)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const DEFAULT_ID_TOKEN_MAX_AGE=300,authIdTokenMaxAge=util.getExperimentalSetting("authIdTokenMaxAge")||300;let lastPostedIdToken=null;const mintCookieFactory=e=>async t=>{const r=t&&await t.getIdTokenResult(),n=r&&((new Date).getTime()-Date.parse(r.issuedAtTime))/1e3;if(n&&n>authIdTokenMaxAge)return;const i=r?.token;lastPostedIdToken!==i&&(lastPostedIdToken=i,await fetch(e,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))};function getAuth(e=app.getApp()){const t=app._getProvider(e,"auth");if(t.isInitialized())return t.getImmediate();const r=initializeAuth(e,{popupRedirectResolver:browserPopupRedirectResolver,persistence:[indexedDBLocalPersistence,browserLocalPersistence,browserSessionPersistence]}),n=util.getExperimentalSetting("authTokenSyncURL");if(n&&"boolean"==typeof isSecureContext&&isSecureContext){const e=new URL(n,location.origin);if(location.origin===e.origin){const t=mintCookieFactory(e.toString());beforeAuthStateChanged(r,t,()=>t(r.currentUser)),onIdTokenChanged(r,e=>t(e))}}const i=util.getDefaultEmulatorHost("auth");return i&&connectAuthEmulator(r,`http://${i}`),r}function getScriptParentElement(){return document.getElementsByTagName("head")?.[0]??document}_setExternalJSProvider({loadJS:e=>new Promise((t,r)=>{const n=document.createElement("script");n.setAttribute("src",e),n.onload=t,n.onerror=e=>{const t=_createError("internal-error");t.customData=e,r(t)},n.type="text/javascript",n.charset="UTF-8",getScriptParentElement().appendChild(n)}),gapiScript:"https://apis.google.com/js/api.js",recaptchaV2Script:"https://www.google.com/recaptcha/api.js",recaptchaEnterpriseScript:"https://www.google.com/recaptcha/enterprise.js?render="}),registerAuth("Browser"),exports.AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY=AUTH_ERROR_CODES_MAP_DO_NOT_USE_INTERNALLY,exports.ActionCodeOperation=ActionCodeOperation,exports.ActionCodeURL=ActionCodeURL,exports.AuthCredential=AuthCredential,exports.AuthEventManager=AuthEventManager,exports.AuthImpl=AuthImpl,exports.AuthPopup=AuthPopup,exports.EmailAuthCredential=EmailAuthCredential,exports.EmailAuthProvider=EmailAuthProvider,exports.FacebookAuthProvider=FacebookAuthProvider,exports.FactorId=FactorId,exports.FetchProvider=FetchProvider,exports.GithubAuthProvider=GithubAuthProvider,exports.GoogleAuthProvider=GoogleAuthProvider,exports.OAuthCredential=OAuthCredential,exports.OAuthProvider=OAuthProvider,exports.OperationType=OperationType,exports.PhoneAuthCredential=PhoneAuthCredential,exports.PhoneAuthProvider=PhoneAuthProvider,exports.PhoneMultiFactorGenerator=PhoneMultiFactorGenerator,exports.ProviderId=ProviderId,exports.RecaptchaVerifier=RecaptchaVerifier,exports.SAMLAuthCredential=SAMLAuthCredential,exports.SAMLAuthProvider=SAMLAuthProvider,exports.SignInMethod=SignInMethod,exports.TotpMultiFactorGenerator=TotpMultiFactorGenerator,exports.TotpSecret=TotpSecret,exports.TwitterAuthProvider=TwitterAuthProvider,exports.UserImpl=UserImpl,exports._assert=_assert,exports._castAuth=_castAuth,exports._clearRedirectOutcomes=_clearRedirectOutcomes,exports._createError=_createError,exports._fail=_fail,exports._generateEventId=_generateEventId,exports._getClientVersion=_getClientVersion,exports._getInstance=_getInstance,exports._getProjectConfig=_getProjectConfig,exports._getRedirectResult=_getRedirectResult,exports._getRedirectUrl=_getRedirectUrl,exports._isAndroid=_isAndroid,exports._isIOS=_isIOS,exports._isIOS7Or8=_isIOS7Or8,exports._overrideRedirectResult=_overrideRedirectResult,exports._persistenceKeyName=_persistenceKeyName,exports.applyActionCode=applyActionCode,exports.beforeAuthStateChanged=beforeAuthStateChanged,exports.browserCookiePersistence=browserCookiePersistence,exports.browserLocalPersistence=browserLocalPersistence,exports.browserPopupRedirectResolver=browserPopupRedirectResolver,exports.browserSessionPersistence=browserSessionPersistence,exports.checkActionCode=checkActionCode,exports.confirmPasswordReset=confirmPasswordReset,exports.connectAuthEmulator=connectAuthEmulator,exports.createUserWithEmailAndPassword=createUserWithEmailAndPassword,exports.debugAssert=debugAssert,exports.debugErrorMap=debugErrorMap,exports.deleteUser=deleteUser,exports.fetchSignInMethodsForEmail=fetchSignInMethodsForEmail,exports.getAdditionalUserInfo=getAdditionalUserInfo,exports.getAuth=getAuth,exports.getIdToken=getIdToken,exports.getIdTokenResult=getIdTokenResult,exports.getMultiFactorResolver=getMultiFactorResolver,exports.getRedirectResult=getRedirectResult,exports.inMemoryPersistence=inMemoryPersistence,exports.indexedDBLocalPersistence=indexedDBLocalPersistence,exports.initializeAuth=initializeAuth,exports.initializeRecaptchaConfig=initializeRecaptchaConfig,exports.isSignInWithEmailLink=isSignInWithEmailLink,exports.linkWithCredential=linkWithCredential,exports.linkWithPhoneNumber=linkWithPhoneNumber,exports.linkWithPopup=linkWithPopup,exports.linkWithRedirect=linkWithRedirect,exports.multiFactor=multiFactor,exports.onAuthStateChanged=onAuthStateChanged,exports.onIdTokenChanged=onIdTokenChanged,exports.parseActionCodeURL=parseActionCodeURL,exports.prodErrorMap=prodErrorMap,exports.reauthenticateWithCredential=reauthenticateWithCredential,exports.reauthenticateWithPhoneNumber=reauthenticateWithPhoneNumber,exports.reauthenticateWithPopup=reauthenticateWithPopup,exports.reauthenticateWithRedirect=reauthenticateWithRedirect,exports.reload=reload,exports.revokeAccessToken=revokeAccessToken,exports.sendEmailVerification=sendEmailVerification,exports.sendPasswordResetEmail=sendPasswordResetEmail,exports.sendSignInLinkToEmail=sendSignInLinkToEmail,exports.setPersistence=setPersistence,exports.signInAnonymously=signInAnonymously,exports.signInWithCredential=signInWithCredential,exports.signInWithCustomToken=signInWithCustomToken,exports.signInWithEmailAndPassword=signInWithEmailAndPassword,exports.signInWithEmailLink=signInWithEmailLink,exports.signInWithPhoneNumber=signInWithPhoneNumber,exports.signInWithPopup=signInWithPopup,exports.signInWithRedirect=signInWithRedirect,exports.signOut=signOut,exports.unlink=unlink,exports.updateCurrentUser=updateCurrentUser,exports.updateEmail=updateEmail,exports.updatePassword=updatePassword,exports.updatePhoneNumber=updatePhoneNumber,exports.updateProfile=updateProfile,exports.useDeviceLanguage=useDeviceLanguage,exports.validatePassword=validatePassword,exports.verifyBeforeUpdateEmail=verifyBeforeUpdateEmail,exports.verifyPasswordResetCode=verifyPasswordResetCode;