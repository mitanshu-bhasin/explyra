...
$root = Join-Path $PSScriptRoot '..\msix'
...
<Package
  ...
  <Applications>
    <Application Id="App" Executable="ExplyraLauncher.exe" EntryPoint="Windows.FullTrustApplication">
      <uap:VisualElements
        DisplayName="Explyra"
      ...
      <Extensions>
        <desktop:Extension Category="windows.fullTrustProcess" Executable="ExplyraLauncher.exe" />
      </Extensions>
    </Application>
  </Applications>
...
$out = Join-Path (Join-Path $PSScriptRoot '..') "Explyra_${Version}_x64_${stamp}.msix"
