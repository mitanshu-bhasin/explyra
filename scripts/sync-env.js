...
`;
    ...
    if (fs.existsSync(path.dirname(mobileOutputPath))) { fs.writeFileSync(mobileOutputPath, outputContent); } else { fs.mkdirSync(path.dirname(mobileOutputPath), { recursive: true }); fs.writeFileSync(mobileOutputPath, outputContent); }
