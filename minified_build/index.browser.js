 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class __PRIVATE_TransactionRunner{constructor(t,e,s,i,r){this.asyncQueue=t,this.datastore=e,this.options=s,this.updateFunction=i,this.deferred=r,this.I=s.maxAttempts,this.P=new __PRIVATE_ExponentialBackoff(this.asyncQueue,"transaction_retry")}V(){this.I-=1,this.D()}D(){this.P.A(async()=>{const t=new Transaction$1(this.datastore),e=this.F(t);e&&e.then(e=>{this.asyncQueue.enqueueAndForget(()=>t.commit().then(()=>{this.deferred.resolve(e)}).catch(t=>{this.v(t)}))}).catch(t=>{this.v(t)})})}F(t){try{const e=this.updateFunction(t);return!nt(e)&&e.catch&&e.then?e:(this.deferred.reject(Error("Transaction callback must return a Promise")),null)}catch(t){return this.deferred.reject(t),null}}v(t){this.I>0&&this.B(t)?(this.I-=1,this.asyncQueue.enqueueAndForget(()=>(this.D(),Promise.resolve()))):this.deferred.reject(t)}B(t){if("FirebaseError"===t?.name){const e=t.code;return"aborted"===e||"failed-precondition"===e||"already-exists"===e||!ot(e)}return!1}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const dt="AsyncQueue";class __PRIVATE_AsyncQueueImpl{constructor(t=Promise.resolve()){this.k=[],this.q=!1,this.O=[],this.S=null,this.C=!1,this.M=!1,this.N=[],this.P=new __PRIVATE_ExponentialBackoff(this,"async_queue_retry"),this.L=()=>{const t=getDocument();t&&a(dt,"Visibility state changed to "+t.visibilityState),this.P.T()},this.W=t;const e=getDocument();e&&"function"==typeof e.addEventListener&&e.addEventListener("visibilitychange",this.L)}get isShuttingDown(){return this.q}enqueueAndForget(t){this.enqueue(t)}enqueueAndForgetEvenWhileRestricted(t){this.U(),this.$(t)}enterRestrictedMode(t){if(!this.q){this.q=!0,this.M=t||!1;const e=getDocument();e&&"function"==typeof e.removeEventListener&&e.removeEventListener("visibilitychange",this.L)}}enqueue(t){if(this.U(),this.q)return new Promise(()=>{});const e=new __PRIVATE_Deferred;return this.$(()=>this.q&&this.M?Promise.resolve():(t().then(e.resolve,e.reject),e.promise)).then(()=>e.promise)}enqueueRetryable(t){this.enqueueAndForget(()=>(this.k.push(t),this.j()))}async j(){if(0!==this.k.length){try{await this.k[0](),this.k.shift(),this.P.reset()}catch(t){if(!function(t){return"IndexedDbTransactionError"===t.name}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t))throw t;a(dt,"Operation failed with retryable error: "+t)}this.k.length>0&&this.P.A(()=>this.j())}}$(t){const e=this.W.then(()=>(this.C=!0,t().catch(t=>{this.S=t,this.C=!1;const e=__PRIVATE_getMessageOrStack(t);throw ht("INTERNAL UNHANDLED ERROR: ",e),t}).then(t=>(this.C=!1,t))));return this.W=e,e}enqueueAfterDelay(t,e,s){this.U(),this.N.indexOf(t)>-1&&(e=0);const i=DelayedOperation.createAndSchedule(this,t,e,s,t=>this.G(t));return this.O.push(i),i}U(){this.S&&rt(47125,{H:__PRIVATE_getMessageOrStack(this.S)})}verifyOperationInProgress(){}async J(){let t;do{t=this.W,await t}while(t!==this.W)}K(t){for(const e of this.O)if(e.timerId===t)return!0;return!1}X(t){return this.J().then(()=>{this.O.sort((t,e)=>t.targetTimeMs-e.targetTimeMs);for(const e of this.O)if(e.skipDelay(),"all"!==t&&e.timerId===t)break;return this.J()})}Y(t){this.N.push(t)}G(t){const e=this.O.indexOf(t);this.O.splice(e,1)}}function __PRIVATE_getMessageOrStack(t){let e=t.message||"";return t.stack&&(e=t.stack.includes(t.message)?t.stack:t.message+"\n"+t.stack),e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
