 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AutoId{static newId(){const e="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789",t=62*Math.floor(256/62);let r="";for(;r.length<20;){const n=randomBytes(40);for(let i=0;i<n.length;++i)r.length<20&&n[i]<t&&(r+=e.charAt(n[i]%62))}return r}}function primitiveComparator(e,t){return e<t?-1:e>t?1:0}function compareUtf8Strings(e,t){const r=Math.min(e.length,t.length);for(let n=0;n<r;n++){const r=e.charAt(n),i=t.charAt(n);if(r!==i)return isSurrogate(r)===isSurrogate(i)?primitiveComparator(r,i):isSurrogate(r)?1:-1}return primitiveComparator(e.length,t.length)}const MIN_SURROGATE=55296,MAX_SURROGATE=57343;function isSurrogate(e){const t=e.charCodeAt(0);return t>=MIN_SURROGATE&&t<=MAX_SURROGATE}function arrayEquals(e,t,r){return e.length===t.length&&e.every((e,n)=>r(e,t[n]))}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let lastUniqueDebugId=null;function generateInitialUniqueDebugId(){const e=268435456;return e+Math.round(2147483648*Math.random())}function generateUniqueDebugId(){return null===lastUniqueDebugId?lastUniqueDebugId=generateInitialUniqueDebugId():lastUniqueDebugId++,"0x"+lastUniqueDebugId.toString(16)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
