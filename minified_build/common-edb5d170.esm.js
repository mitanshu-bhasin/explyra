 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const S=new Logger("@firebase/firestore");function __PRIVATE_getLogLevel(){return S.logLevel}function setLogLevel(e){S.setLogLevel(e)}function __PRIVATE_logDebug(e,...t){if(S.logLevel<=LogLevel.DEBUG){const n=t.map(__PRIVATE_argToString);S.debug(`Firestore (${b}): ${e}`,...n)}}function __PRIVATE_logError(e,...t){if(S.logLevel<=LogLevel.ERROR){const n=t.map(__PRIVATE_argToString);S.error(`Firestore (${b}): ${e}`,...n)}}function __PRIVATE_logWarn(e,...t){if(S.logLevel<=LogLevel.WARN){const n=t.map(__PRIVATE_argToString);S.warn(`Firestore (${b}): ${e}`,...n)}}function __PRIVATE_argToString(e){if("string"==typeof e)return e;try{return function(e){return JSON.stringify(e)}(e)}catch(t){return e}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function property(e,t){const n={typeString:e};return t&&(n.value=t),n}function __PRIVATE_validateJSON(e,t){if(!__PRIVATE_isPlainObject(e))throw new FirestoreError(D.INVALID_ARGUMENT,"JSON must be an object");let n;for(const r in t)if(t[r]){const s=t[r].typeString,i="value"in t[r]?{value:t[r].value}:void 0;if(!(r in e)){n=`JSON missing required field: '${r}'`;break}const o=e[r];if(s&&typeof o!==s){n=`JSON field '${r}' must be a ${s}.`;break}if(void 0!==i&&o!==i.value){n=`Expected '${r}' field to equal '${i.value}'`;break}}if(n)throw new FirestoreError(D.INVALID_ARGUMENT,n);return!0}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return __PRIVATE_primitiveComparator(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}ByteString.EMPTY_BYTE_STRING=new ByteString("");const Ye=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);function __PRIVATE_normalizeTimestamp(e){if(__PRIVATE_hardAssert(!!e,39018),"string"==typeof e){let t=0;const n=Ye.exec(e);if(__PRIVATE_hardAssert(!!n,46558,{timestamp:e}),n[1]){let e=n[1];e=(e+"000000000").substr(0,9),t=Number(e)}const r=new Date(e);return{seconds:Math.floor(r.getTime()/1e3),nanos:t}}return{seconds:__PRIVATE_normalizeNumber(e.seconds),nanos:__PRIVATE_normalizeNumber(e.nanos)}}function __PRIVATE_normalizeNumber(e){return"number"==typeof e?e:"string"==typeof e?Number(e):0}function __PRIVATE_normalizeByteString(e){return"string"==typeof e?ByteString.fromBase64String(e):ByteString.fromUint8Array(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class __PRIVATE_IndexedDbDocumentOverlayCache{constructor(e,t){this.serializer=e,this.userId=t}static wt(e,t){const n=t.uid||"";return new __PRIVATE_IndexedDbDocumentOverlayCache(e,n)}getOverlay(e,t){return __PRIVATE_documentOverlayStore(e).get(__PRIVATE_toDbDocumentOverlayKey(this.userId,t)).next(e=>e?__PRIVATE_fromDbDocumentOverlay(this.serializer,e):null)}getOverlays(e,t){const n=__PRIVATE_newOverlayMap();return PersistencePromise.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&n.set(t,e)})).next(()=>n)}saveOverlays(e,t,n){const r=[];return n.forEach((n,s)=>{const i=new Overlay(t,s);r.push(this.St(e,i))}),PersistencePromise.waitFor(r)}removeOverlaysForBatchId(e,t,n){const r=new Set;t.forEach(e=>r.add(__PRIVATE_encodeResourcePath(e.getCollectionPath())));const s=[];return r.forEach(t=>{const r=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,n+1],!1,!0);s.push(__PRIVATE_documentOverlayStore(e).X(ke,r))}),PersistencePromise.waitFor(s)}getOverlaysForCollection(e,t,n){const r=__PRIVATE_newOverlayMap(),s=__PRIVATE_encodeResourcePath(t),i=IDBKeyRange.bound([this.userId,s,n],[this.userId,s,Number.POSITIVE_INFINITY],!0);return __PRIVATE_documentOverlayStore(e).J(ke,i).next(e=>{for(const t of e){const e=__PRIVATE_fromDbDocumentOverlay(this.serializer,t);r.set(e.getKey(),e)}return r})}getOverlaysForCollectionGroup(e,t,n,r){const s=__PRIVATE_newOverlayMap();let i;const o=IDBKeyRange.bound([this.userId,t,n],[this.userId,t,Number.POSITIVE_INFINITY],!0);return __PRIVATE_documentOverlayStore(e).ee({index:qe,range:o},(e,t,n)=>{const o=__PRIVATE_fromDbDocumentOverlay(this.serializer,t);s.size()<r||o.largestBatchId===i?(s.set(o.getKey(),o),i=o.largestBatchId):n.done()}).next(()=>s)}St(e,t){return __PRIVATE_documentOverlayStore(e).put(function(e,t,n){const[r,s,i]=__PRIVATE_toDbDocumentOverlayKey(t,n.mutation.key);return{userId:t,collectionPath:s,documentId:i,collectionGroup:n.mutation.key.getCollectionGroup(),largestBatchId:n.largestBatchId,overlayMutation:toMutation(e.yt,n.mutation)}}(this.serializer,this.userId,t))}}function __PRIVATE_documentOverlayStore(e){return __PRIVATE_getStore(e,Be)}
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function removeMutationBatch(e,t,n){const r=e.store(j),s=e.store(Y),i=[],o=IDBKeyRange.only(n.batchId);let a=0;const u=r.ee({range:o},(e,t,n)=>(a++,n.delete()));i.push(u.next(()=>{__PRIVATE_hardAssert(1===a,47070,{batchId:n.batchId})}));const c=[];for(const e of n.mutations){const r=__PRIVATE_newDbDocumentMutationKey(t,e.key.path,n.batchId);i.push(s.delete(r)),c.push(e.key)}return PersistencePromise.waitFor(i).next(()=>c)}function __PRIVATE_dbDocumentSize(e){if(!e)return 0;let t;if(e.document)t=e.document;else if(e.unknownDocument)t=e.unknownDocument;else{if(!e.noDocument)throw fail(14731);t=e.noDocument}return JSON.stringify(t).length}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class __PRIVATE_SchemaConverter{constructor(e){this.serializer=e}k(e,t,n,r){const s=new __PRIVATE_SimpleDbTransaction("createOrUpgrade",t);n<1&&r>=1&&(function(e){e.createObjectStore(W)}(e),function(e){e.createObjectStore(G,{keyPath:z});e.createObjectStore(j,{keyPath:H,autoIncrement:!0}).createIndex(J,Z,{unique:!0}),e.createObjectStore(Y)}(e),__PRIVATE_createQueryCache(e),function(e){e.createObjectStore($)}(e));let i=PersistencePromise.resolve();return n<3&&r>=3&&(0!==n&&(function(e){e.deleteObjectStore(le),e.deleteObjectStore(ae),e.deleteObjectStore(Ee)}(e),__PRIVATE_createQueryCache(e)),i=i.next(()=>function(e){const t=e.store(Ee),n={highestTargetId:0,highestListenSequenceNumber:0,lastRemoteSnapshotVersion:SnapshotVersion.min().toTimestamp(),targetCount:0};return t.put(Ie,n)}(s))),n<4&&r>=4&&(0!==n&&(i=i.next(()=>function(e,t){return t.store(j).J().next(n=>{e.deleteObjectStore(j),e.createObjectStore(j,{keyPath:H,autoIncrement:!0}).createIndex(J,Z,{unique:!0});const r=t.store(j),s=n.map(e=>r.put(e));return PersistencePromise.waitFor(s)})}(e,s))),i=i.next(()=>{!function(e){e.createObjectStore(Ve,{keyPath:de})}(e)})),n<5&&r>=5&&(i=i.next(()=>this.gi(s))),n<6&&r>=6&&(i=i.next(()=>(function(e){e.createObjectStore(oe)}(e),this.pi(s)))),n<7&&r>=7&&(i=i.next(()=>this.yi(s))),n<8&&r>=8&&(i=i.next(()=>this.wi(e,s))),n<9&&r>=9&&(i=i.next(()=>{!function(e){e.objectStoreNames.contains("remoteDocumentChanges")&&e.deleteObjectStore("remoteDocumentChanges")}(e)})),n<10&&r>=10&&(i=i.next(()=>this.Si(s))),n<11&&r>=11&&(i=i.next(()=>{!function(e){e.createObjectStore(me,{keyPath:fe})}(e),function(e){e.createObjectStore(ge,{keyPath:pe})}(e)})),n<12&&r>=12&&(i=i.next(()=>{!function(e){const t=e.createObjectStore(Be,{keyPath:Le});t.createIndex(ke,Ke,{unique:!1}),t.createIndex(qe,Ue,{unique:!1})}(e)})),n<13&&r>=13&&(i=i.next(()=>function(e){const t=e.createObjectStore(ee,{keyPath:te});t.createIndex(ne,re),t.createIndex(ie,se)}(e)).next(()=>this.bi(e,s)).next(()=>e.deleteObjectStore($))),n<14&&r>=14&&(i=i.next(()=>this.Di(e,s))),n<15&&r>=15&&(i=i.next(()=>function(e){e.createObjectStore(ye,{keyPath:we,autoIncrement:!0}).createIndex(be,Se,{unique:!1});e.createObjectStore(De,{keyPath:Ce}).createIndex(ve,Fe,{unique:!1});e.createObjectStore(Me,{keyPath:xe}).createIndex(Oe,Ne,{unique:!1})}(e))),n<16&&r>=16&&(i=i.next(()=>{t.objectStore(De).clear()}).next(()=>{t.objectStore(Me).clear()})),n<17&&r>=17&&(i=i.next(()=>{!function(e){e.createObjectStore($e,{keyPath:We})}(e)})),n<18&&r>=18&&isSafariOrWebkit()&&(i=i.next(()=>{t.objectStore(De).clear()}).next(()=>{t.objectStore(Me).clear()})),i}pi(e){let t=0;return e.store($).ee((e,n)=>{t+=__PRIVATE_dbDocumentSize(n)}).next(()=>{const n={byteSize:t};return e.store(oe).put(_e,n)})}gi(e){const t=e.store(G),n=e.store(j);return t.J().next(t=>PersistencePromise.forEach(t,t=>{const r=IDBKeyRange.bound([t.userId,q],[t.userId,t.lastAcknowledgedBatchId]);return n.J(J,r).next(n=>PersistencePromise.forEach(n,n=>{__PRIVATE_hardAssert(n.userId===t.userId,18650,"Cannot process batch from unexpected user",{batchId:n.batchId});const r=__PRIVATE_fromDbMutationBatch(this.serializer,n);return removeMutationBatch(e,t.userId,r).next(()=>{})}))}))}yi(e){const t=e.store(le),n=e.store($);return e.store(Ee).get(Ie).next(e=>{const r=[];return n.ee((n,s)=>{const i=new ResourcePath(n),o=function(e){return[0,__PRIVATE_encodeResourcePath(e)]}(i);r.push(t.get(o).next(n=>n?PersistencePromise.resolve():(n=>t.put({targetId:0,path:__PRIVATE_encodeResourcePath(n),sequenceNumber:e.highestListenSequenceNumber}))(i)))}).next(()=>PersistencePromise.waitFor(r))})}wi(e,t){e.createObjectStore(Re,{keyPath:Ae});const n=t.store(Re),r=new __PRIVATE_MemoryCollectionParentIndex,s=e=>{if(r.add(e)){const t=e.lastSegment(),r=e.popLast();return n.put({collectionId:t,parent:__PRIVATE_encodeResourcePath(r)})}};return t.store($).ee({Y:!0},(e,t)=>{const n=new ResourcePath(e);return s(n.popLast())}).next(()=>t.store(Y).ee({Y:!0},([e,t,n],r)=>{const i=__PRIVATE_decodeResourcePath(t);return s(i.popLast())}))}Si(e){const t=e.store(ae);return t.ee((e,n)=>{const r=__PRIVATE_fromDbTarget(n),s=__PRIVATE_toDbTarget(this.serializer,r);return t.put(s)})}bi(e,t){const n=t.store($),r=[];return n.ee((e,n)=>{const s=t.store(ee),i=function(e){return e.document?new DocumentKey(ResourcePath.fromString(e.document.name).popFirst(5)):e.noDocument?DocumentKey.fromSegments(e.noDocument.path):e.unknownDocument?DocumentKey.fromSegments(e.unknownDocument.path):fail(36783)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Lt="firestore_clients";function createWebStorageClientStateKey(e,t){return`${Lt}_${e}_${t}`}const kt="firestore_mutations";function createWebStorageMutationBatchKey(e,t,n){let r=`${kt}_${e}_${n}`;return t.isAuthenticated()&&(r+=`_${t.uid}`),r}const Kt="firestore_targets";function createWebStorageQueryTargetMetadataKey(e,t){return`${Kt}_${e}_${t}`}
/**
 * @license
 * Copyright 2018 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}const Wt="RestConnection",Qt={BatchGetDocuments:"batchGet",Commit:"commit",RunQuery:"runQuery",RunAggregationQuery:"runAggregationQuery",ExecutePipeline:"executePipeline"};class __PRIVATE_RestConnection{get qo(){return!1}constructor(e){this.databaseInfo=e,this.databaseId=e.databaseId;const t=e.ssl?"https":"http",n=encodeURIComponent(this.databaseId.projectId),r=encodeURIComponent(this.databaseId.database);this.Ko=t+"://"+e.host,this.Uo=`projects/${n}/databases/${r}`,this.$o=this.databaseId.database===it?`project_id=${n}`:`project_id=${n}&database_id=${r}`}Wo(e,t,n,r,s){const i=__PRIVATE_generateUniqueDebugId(),o=this.Qo(e,t.toUriEncodedString());__PRIVATE_logDebug(Wt,`Sending RPC '${e}' ${i}:`,o,n);const a={"google-cloud-resource-prefix":this.Uo,"x-goog-request-params":this.$o};this.Go(a,r,s);const{host:u}=new URL(o),c=isCloudWorkstation(u);return this.zo(e,o,a,n,c).then(t=>(__PRIVATE_logDebug(Wt,`Received RPC '${e}' ${i}: `,t),t),t=>{throw __PRIVATE_logWarn(Wt,`RPC '${e}' ${i} failed with error: `,t,"url: ",o,"request:",n),t})}jo(e,t,n,r,s,i){return this.Wo(e,t,n,r,s)}Go(e,t,n){e["X-Goog-Api-Client"]="gl-js/ fire/"+b,e["Content-Type"]="text/plain",this.databaseInfo.appId&&(e["X-Firebase-GMPID"]=this.databaseInfo.appId),t&&t.headers.forEach((t,n)=>e[n]=t),n&&n.headers.forEach((t,n)=>e[n]=t)}Qo(e,t){const n=Qt[e];let r=`${this.Ko}/v1/${t}:${n}`;return this.databaseInfo.apiKey&&(r=`${r}?key=${encodeURIComponent(this.databaseInfo.apiKey)}`),r}terminate(){}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Gt="WebChannelConnection",__PRIVATE_unguardedEventListen=(e,t,n)=>{e.listen(t,e=>{try{n(e)}catch(e){setTimeout(()=>{throw e},0)}})};class __PRIVATE_WebChannelConnection extends __PRIVATE_RestConnection{constructor(e){super(e),this.a_=[],this.forceLongPolling=e.forceLongPolling,this.autoDetectLongPolling=e.autoDetectLongPolling,this.useFetchStreams=e.useFetchStreams,this.longPollingOptions=e.longPollingOptions}static u_(){if(!__PRIVATE_WebChannelConnection.c_){const e=getStatEventTarget();__PRIVATE_unguardedEventListen(e,Event.STAT_EVENT,e=>{e.stat===Stat.PROXY?__PRIVATE_logDebug(Gt,"STAT_EVENT: detected buffering proxy"):e.stat===Stat.NOPROXY&&__PRIVATE_logDebug(Gt,"STAT_EVENT: detected no buffering proxy")}),__PRIVATE_WebChannelConnection.c_=!0}}zo(e,t,n,r,s){const i=__PRIVATE_generateUniqueDebugId();return new Promise((s,o)=>{const a=new XhrIo;a.setWithCredentials(!0),a.listenOnce(EventType.COMPLETE,()=>{try{switch(a.getLastErrorCode()){case ErrorCode.NO_ERROR:const t=a.getResponseJson();__PRIVATE_logDebug(Gt,`XHR for RPC '${e}' ${i} received:`,JSON.stringify(t)),s(t);break;case ErrorCode.TIMEOUT:__PRIVATE_logDebug(Gt,`RPC '${e}' ${i} timed out`),o(new FirestoreError(D.DEADLINE_EXCEEDED,"Request time out"));break;case ErrorCode.HTTP_ERROR:const n=a.getStatus();if(__PRIVATE_logDebug(Gt,`RPC '${e}' ${i} failed with status:`,n,"response text:",a.getResponseText()),n>0){let e=a.getResponseJson();Array.isArray(e)&&(e=e[0]);const t=e?.error;if(t&&t.status&&t.message){const e=function(e){const t=e.toLowerCase().replace(/_/g,"-");return Object.values(D).indexOf(t)>=0?t:D.UNKNOWN}(t.status);o(new FirestoreError(e,t.message))}else o(new FirestoreError(D.UNKNOWN,"Server responded with status "+a.getStatus()))}else o(new FirestoreError(D.UNAVAILABLE,"Connection failed."));break;default:fail(9055,{l_:e,streamId:i,h_:a.getLastErrorCode(),P_:a.getLastError()})}}finally{__PRIVATE_logDebug(Gt,`RPC '${e}' ${i} completed.`)}});const u=JSON.stringify(r);__PRIVATE_logDebug(Gt,`RPC '${e}' ${i} sending request:`,r),a.send(t,"POST",u,n,15)})}T_(e,t,n){const r=__PRIVATE_generateUniqueDebugId(),s=[this.Ko,"/","google.firestore.v1.Firestore","/",e,"/channel"],i=this.createWebChannelTransport(),o={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},a=this.longPollingOptions.timeoutSeconds;void 0!==a&&(o.longPollingTimeout=Math.round(1e3*a)),this.useFetchStreams&&(o.useFetchStreams=!0),this.Go(o.initMessageHeaders,t,n),o.encodeInitMessageHeaders=!0;const u=s.join("");__PRIVATE_logDebug(Gt,`Creating RPC '${e}' stream ${r}: ${u}`,o);const c=i.createWebChannel(u,o);this.E_(c);let _=!1,l=!1;const h=new __PRIVATE_StreamBridge({Jo:t=>{l?__PRIVATE_logDebug(Gt,`Not sending because RPC '${e}' stream ${r} is closed:`,t):(_||(__PRIVATE_logDebug(Gt,`Opening RPC '${e}' stream ${r} transport.`),c.open(),_=!0),__PRIVATE_logDebug(Gt,`RPC '${e}' stream ${r} sending:`,t),c.send(t))},Ho:()=>c.close()});return __PRIVATE_unguardedEventListen(c,WebChannel.EventType.OPEN,()=>{l||(__PRIVATE_logDebug(Gt,`RPC '${e}' stream ${r} transport opened.`),h.i_())}),__PRIVATE_unguardedEventListen(c,WebChannel.EventType.CLOSE,()=>{l||(l=!0,__PRIVATE_logDebug(Gt,`RPC '${e}' stream ${r} transport closed`),h.o_(),this.I_(c))}),__PRIVATE_unguardedEventListen(c,WebChannel.EventType.ERROR,t=>{l||(l=!0,__PRIVATE_logWarn(Gt,`RPC '${e}' stream ${r} transport errored. Name:`,t.name,"Message:",t.message),h.o_(new FirestoreError(D.UNAVAILABLE,"The operation could not be completed")))}),__PRIVATE_unguardedEventListen(c,WebChannel.EventType.MESSAGE,t=>{if(!l){const n=t.data[0];__PRIVATE_hardAssert(!!n,16349);const s=n,i=s?.error||s[0]?.error;if(i){__PRIVATE_logDebug(Gt,`RPC '${e}' stream ${r} received error:`,i);const t=i.status;let n=function(e){const t=Rt[e];if(void 0!==t)return __PRIVATE_mapCodeFromRpcCode(t)}(t),s=i.message;"NOT_FOUND"===t&&s.includes("database")&&s.includes("does not exist")&&s.includes(this.databaseId.database)&&__PRIVATE_logWarn(`Database '${this.databaseId.database}' not found. Please check your project configuration.`),void 0===n&&(n=D.INTERNAL,s="Unknown error status: "+t+" with message "+i.message),l=!0,h.o_(new FirestoreError(n,s)),c.close()}else __PRIVATE_logDebug(Gt,`RPC '${e}' stream ${r} received:`,n),h.__(n)}}),__PRIVATE_WebChannelConnection.u_(),setTimeout(()=>{h.s_()},0),h}terminate(){this.a_.forEach(e=>e.close()),this.a_=[]}E_(e){this.a_.push(e)}I_(e){this.a_=this.a_.filter(t=>t===e)}Go(e,t,n){super.Go(e,t,n),this.databaseInfo.apiKey&&(e["x-goog-api-key"]=this.databaseInfo.apiKey)}createWebChannelTransport(){return createWebChannelTransport()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class __PRIVATE_BundleReaderSyncImpl{constructor(e,t){this.bundleData=e,this.serializer=t,this.cursor=0,this.elements=[];let n=this.bu();if(!n||!n.Ua())throw new Error(`The first element of the bundle is not a metadata object, it is\n         ${JSON.stringify(n?.Ka)}`);this.metadata=n;do{n=this.bu(),null!==n&&this.elements.push(n)}while(null!==n)}getMetadata(){return this.metadata}Qu(){return this.elements}bu(){if(this.cursor===this.bundleData.length)return null;const e=this.qu(),t=this.Uu(e);return new __PRIVATE_SizedBundleElement(JSON.parse(t),e)}Uu(e){if(this.cursor+e>this.bundleData.length)throw new FirestoreError(D.INTERNAL,"Reached the end of bundle when more is expected.");return this.bundleData.slice(this.cursor,this.cursor+=e)}qu(){const e=this.cursor;let t=this.cursor;for(;t<this.bundleData.length;){if("{"===this.bundleData[t]){if(t===e)throw new Error("First character is a bracket and not a number");return this.cursor=t,Number(this.bundleData.slice(e,t))}t++}throw new Error("Reached the end of bundle when more is expected.")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */}const Yt="ComponentProvider",en=new Map;function __PRIVATE_makeDatabaseInfo(e,t,n,r,s){return new DatabaseInfo(e,t,n,s.host,s.ssl,s.experimentalForceLongPolling,s.experimentalAutoDetectLongPolling,__PRIVATE_cloneLongPollingOptions(s.experimentalLongPollingOptions),s.useFetchStreams,s.isUsingEmulator,r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
