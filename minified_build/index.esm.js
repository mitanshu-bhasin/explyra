import{_isFirebaseServerApp,_removeServiceInstance,getApp,_getProvider,_registerComponent,registerVersion,SDK_VERSION as SDK_VERSION$1}from"@firebase/app";import{Component}from"@firebase/component";import{FirebaseError,generateSHA256Hash,isCloudWorkstation,pingServer}from"@firebase/util";import{Logger}from"@firebase/logger";const name="@firebase/data-connect",version="0.5.0";
/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class AppCheckTokenProvider{constructor(e,t){this.appCheckProvider=t,_isFirebaseServerApp(e)&&e.settings.appCheckToken&&(this.serverAppAppCheckToken=e.settings.appCheckToken),this.appCheck=t?.getImmediate({optional:!0}),this.appCheck||t?.get().then(e=>this.appCheck=e).catch()}getToken(){return this.serverAppAppCheckToken?Promise.resolve({token:this.serverAppAppCheckToken}):this.appCheck?this.appCheck.getToken():new Promise((e,t)=>{setTimeout(()=>{this.appCheck?this.getToken().then(e,t):e(null)},0)})}addTokenChangeListener(e){this.appCheckProvider?.get().then(t=>t.addTokenListener(e))}}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const logger=new Logger("@firebase/data-connect");function setLogLevel(e){logger.setLogLevel(e)}function logDebug(e){logger.debug(`DataConnect (${SDK_VERSION}): ${e}`)}function logError(e){logger.error(`DataConnect (${SDK_VERSION}): ${e}`)}
/**
 * @license
 * Copyright 2024 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function registerDataConnect(e){setSDKVersion(SDK_VERSION$1),_registerComponent(new Component("data-connect",(e,{instanceIdentifier:t,options:r})=>{const s=e.getProvider("app").getImmediate(),i=e.getProvider("auth-internal"),n=e.getProvider("app-check-internal");let a=r;if(t&&(a={...JSON.parse(t),...a}),!s.options.projectId)throw new DataConnectError(Code.INVALID_ARGUMENT,"Project ID must be provided. Did you pass in a proper projectId to initializeApp?");return new DataConnect(s,{...a,projectId:s.options.projectId},i,n)},"PUBLIC").setMultipleInstances(!0)),registerVersion(name,"0.5.0",e),registerVersion(name,"0.5.0","esm2020")}
/**
 * @license
 * Copyright 2025 Google LLC
 *
