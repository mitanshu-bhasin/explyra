 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ct(t){return Number.isFinite(t)?t+function(t){t=Math.abs(t);const e=t%100;if(e>=10&&e<=20)return"th";const n=t%10;if(1===n)return"st";if(2===n)return"nd";if(3===n)return"rd";return"th"}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class r{constructor(t,e){this.name=t,this.container=e,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}get(t){const n=this.normalizeInstanceIdentifier(t);if(!this.instancesDeferred.has(n)){const t=new e.Deferred;if(this.instancesDeferred.set(n,t),this.isInitialized(n)||this.shouldAutoInitialize())try{const e=this.getOrInitializeService({instanceIdentifier:n});e&&t.resolve(e)}catch(t){}}return this.instancesDeferred.get(n).promise}getImmediate(t){const e=this.normalizeInstanceIdentifier(t?.identifier),n=t?.optional??!1;if(!this.isInitialized(e)&&!this.shouldAutoInitialize()){if(n)return null;throw Error(`Service ${this.name} is not available`)}try{return this.getOrInitializeService({instanceIdentifier:e})}catch(t){if(n)return null;throw t}}getComponent(){return this.component}setComponent(t){if(t.name!==this.name)throw Error(`Mismatching Component ${t.name} for Provider ${this.name}.`);if(this.component)throw Error(`Component for ${this.name} has already been provided`);if(this.component=t,this.shouldAutoInitialize()){if(function(t){return"EAGER"===t.instantiationMode}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Z(t,e){const n=(0,i.base64Decode)(t.split(".")[1]);if(null===n)return void console.error(`FirebaseServerApp ${e} is invalid: second part could not be parsed.`);if(void 0===JSON.parse(n).exp)return void console.error(`FirebaseServerApp ${e} is invalid: expiration claim could not be parsed`);1e3*JSON.parse(n).exp-(new Date).getTime()<=0&&console.error(`FirebaseServerApp ${e} is invalid: the token has expired.`)}class Q extends q{constructor(t,e,n,i){const r=void 0===e.automaticDataCollectionEnabled||e.automaticDataCollectionEnabled,s={name:n,automaticDataCollectionEnabled:r};if(void 0!==t.apiKey)super(t,s,i);else{super(t.options,s,i)}this._serverConfig={automaticDataCollectionEnabled:r,...e},this._serverConfig.authIdToken&&Z(this._serverConfig.authIdToken,"authIdToken"),this._serverConfig.appCheckToken&&Z(this._serverConfig.appCheckToken,"appCheckToken"),this._finalizationRegistry=null,"undefined"!=typeof FinalizationRegistry&&(this._finalizationRegistry=new FinalizationRegistry(()=>{this.automaticCleanup()})),this._refCount=0,this.incRefCount(this._serverConfig.releaseOnDeref),this._serverConfig.releaseOnDeref=void 0,e.releaseOnDeref=void 0,ot(o,a,"serverapp")}toJSON(){}get refCount(){return this._refCount}incRefCount(t){this.isDeleted||(this._refCount++,void 0!==t&&null!==this._finalizationRegistry&&this._finalizationRegistry.register(t,this))}decRefCount(){return this.isDeleted?0:--this._refCount}automaticCleanup(){st(this)}get settings(){return this.checkDestroyed(),this._serverConfig}checkDestroyed(){if(this.isDeleted)throw Y.create("server-app-deleted")}}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const tt="12.11.0";function et(t,n={}){let r=t;if("object"!=typeof n){n={name:n}}const s={name:M,automaticDataCollectionEnabled:!0,...n},o=s.name;if("string"!=typeof o||!o)throw Y.create("bad-app-name",{appName:String(o)});if(r||(r=(0,i.getDefaultAppConfig)()),!r)throw Y.create("no-options");const a=N.get(o);if(a){if((0,i.deepEqual)(r,a.options)&&(0,i.deepEqual)(s,a.config))return a;throw Y.create("duplicate-app",{appName:o})}const h=new e.ComponentContainer(o);for(const t of H.values())h.addComponent(t);const c=new q(r,s,h);return N.set(o,c),c}function nt(t,n={}){if((0,i.isBrowser)()&&!(0,i.isWebWorker)())throw Y.create("invalid-server-app-environment");let r,s=n||{};if(t&&(V(t)?r=t.options:X(t)?s=t:r=t),void 0===s.automaticDataCollectionEnabled&&(s.automaticDataCollectionEnabled=!0),r||(r=(0,i.getDefaultAppConfig)()),!r)throw Y.create("no-options");const o={...s,...r};void 0!==o.releaseOnDeref&&delete o.releaseOnDeref;if(void 0!==s.releaseOnDeref&&"undefined"==typeof FinalizationRegistry)throw Y.create("finalization-registry-not-supported",{});const a=""+(h=JSON.stringify(o),[...h].reduce((t,e)=>Math.imul(31,t)+e.charCodeAt(0)|0,0));var h;const c=B.get(a);if(c)return c.incRefCount(s.releaseOnDeref),c;const l=new e.ComponentContainer(a);for(const t of H.values())l.addComponent(t);const u=new Q(r,s,a,l);return B.set(a,u),u}function it(t=M){const e=N.get(t);if(!e&&t===M&&(0,i.getDefaultAppConfig)())return et();if(!e)throw Y.create("no-app",{appName:t});return e}function rt(){return Array.from(N.values())}async function st(t){let e=!1;const n=t.name;if(N.has(n))e=!0,N.delete(n);else if(B.has(n)){t.decRefCount()<=0&&(B.delete(n),e=!0)}e&&(await Promise.all(t.container.getProviders().map(t=>t.delete())),t.isDeleted=!0)}function ot(t,n,i){let r=P[t]??t;i&&(r+=`-${i}`);const s=r.match(/\s|\//),o=n.match(/\s|\//);if(s||o){const t=[`Unable to register library "${r}" with version "${n}":`];return s&&t.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&o&&t.push("and"),o&&t.push(`version name "${n}" contains illegal characters (whitespace or "/")`),void h.warn(t.join(" "))}U(new e.Component(`${r}-version`,()=>({library:r,version:n}),"VERSION"))}function at(t,e){if(null!==t&&"function"!=typeof t)throw Y.create("invalid-log-argument");(0,n.setUserLogHandler)(t,e)}function ht(t){(0,n.setLogLevel)(t)}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ct="firebase-heartbeat-store";let lt=null;function ut(){return lt||(lt=(0,r.openDB)("firebase-heartbeat-database",1,{upgrade:(t,e)=>{if(0===e)try{t.createObjectStore(ct)}catch(t){console.warn(t)}}}).catch(t=>{throw Y.create("idb-open",{originalErrorMessage:t.message})})),lt}async function ft(t,e){try{const n=(await ut()).transaction(ct,"readwrite"),i=n.objectStore(ct);await i.put(e,pt(t)),await n.done}catch(t){if(t instanceof i.FirebaseError)h.warn(t.message);else{const e=Y.create("idb-set",{originalErrorMessage:t?.message});h.warn(e.message)}}}function pt(t){return`${t.name}!${t.options.appId}`}
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class dt{constructor(t){this.container=t,this._heartbeatsCache=null;const e=this.container.getProvider("app").getImmediate();this._storage=new mt(e),this._heartbeatsCachePromise=this._storage.read().then(t=>(this._heartbeatsCache=t,t))}async triggerHeartbeat(){try{const t=this.container.getProvider("platform-logger").getImmediate().getPlatformInfoString(),e=gt();if(null==this._heartbeatsCache?.heartbeats&&(this._heartbeatsCache=await this._heartbeatsCachePromise,null==this._heartbeatsCache?.heartbeats))return;if(this._heartbeatsCache.lastSentHeartbeatDate===e||this._heartbeatsCache.heartbeats.some(t=>t.date===e))return;if(this._heartbeatsCache.heartbeats.push({date:e,agent:t}),this._heartbeatsCache.heartbeats.length>30){const t=function(t){if(0===t.length)return-1;let e=0,n=t[0].date;for(let i=1;i<t.length;i++)t[i].date<n&&(n=t[i].date,e=i);return e}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(this._heartbeatsCache.heartbeats);this._heartbeatsCache.heartbeats.splice(t,1)}return this._storage.overwrite(this._heartbeatsCache)}catch(t){h.warn(t)}}async getHeartbeatsHeader(){try{if(null===this._heartbeatsCache&&await this._heartbeatsCachePromise,null==this._heartbeatsCache?.heartbeats||0===this._heartbeatsCache.heartbeats.length)return"";const t=gt(),{heartbeatsToSend:e,unsentEntries:n}=function(t,e=1024){const n=[];let i=t.slice();for(const r of t){const t=n.find(t=>t.agent===r.agent);if(t){if(t.dates.push(r.date),bt(n)>e){t.dates.pop();break}}else if(n.push({agent:r.agent,dates:[r.date]}),bt(n)>e){n.pop();break}i=i.slice(1)}return{heartbeatsToSend:n,unsentEntries:i}}(this._heartbeatsCache.heartbeats),r=(0,i.base64urlEncodeWithoutPadding)(JSON.stringify({version:2,heartbeats:e}));return this._heartbeatsCache.lastSentHeartbeatDate=t,n.length>0?(this._heartbeatsCache.heartbeats=n,await this._storage.overwrite(this._heartbeatsCache)):(this._heartbeatsCache.heartbeats=[],this._storage.overwrite(this._heartbeatsCache)),r}catch(t){return h.warn(t),""}}}function gt(){return(new Date).toISOString().substring(0,10)}class mt{constructor(t){this.app=t,this._canUseIndexedDBPromise=this.runIndexedDBEnvironmentCheck()}async runIndexedDBEnvironmentCheck(){return!!(0,i.isIndexedDBAvailable)()&&(0,i.validateIndexedDBOpenable)().then(()=>!0).catch(()=>!1)}async read(){if(await this._canUseIndexedDBPromise){const t=await async function(t){try{const e=(await ut()).transaction(ct),n=await e.objectStore(ct).get(pt(t));return await e.done,n}catch(t){if(t instanceof i.FirebaseError)h.warn(t.message);else{const e=Y.create("idb-get",{originalErrorMessage:t?.message});h.warn(e.message)}}}(this.app);return t?.heartbeats?t:{heartbeats:[]}}return{heartbeats:[]}}async overwrite(t){if(await this._canUseIndexedDBPromise){const e=await this.read();return ft(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??e.lastSentHeartbeatDate,heartbeats:t.heartbeats})}}async add(t){if(await this._canUseIndexedDBPromise){const e=await this.read();return ft(this.app,{lastSentHeartbeatDate:t.lastSentHeartbeatDate??e.lastSentHeartbeatDate,heartbeats:[...e.heartbeats,...t.heartbeats]})}}}function bt(t){return(0,i.base64urlEncodeWithoutPadding)(JSON.stringify({version:2,heartbeats:t})).length}var yt;yt="",U(new e.Component("platform-logger",t=>new s(t),"PRIVATE")),U(new e.Component("heartbeat",t=>new dt(t),"PRIVATE")),ot(o,a,yt),ot(o,a,"esm2020"),ot("fire-js","")},"[project]/booking/node_modules/firebase/auth/dist/esm/index.esm.js [app-client] (ecmascript) <locals>",t=>{"use strict";t.s([]);t.i("[project]/booking/node_modules/@firebase/auth/dist/esm/index.js [app-client] (ecmascript) <locals>")},"[project]/booking/node_modules/firebase/app/dist/esm/index.esm.js [app-client] (ecmascript) <locals>",t=>{"use strict";t.s([]);
/**
 * @license
 * Copyright 2020 Google LLC
 *
